...
def process_node(target_node_ip, target_node_port):
    ...
    try:
        ...
        time.sleep(10)  # Allow more time for the node to process and respond


        addresses = []

        # Loop to receive multiple messages for a defined period

        start_time = time.time()

        while time.time() - start_time < 60:  # Running the loop for 60 seconds
...
if __name__ == '__main__':
    ...
    # Replace with the IP and port of the node you want to test

    target_node_ip = "138.201.252.11"
